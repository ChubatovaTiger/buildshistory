...
object Subpr1 : Project({
    ...
    vcsRoot(Subpr1_HttpsGithubComChubatovaTigerChubatovaGradleTestsBackup)

    buildType(Subpr1_B131)
    buildType(Subpr1_B121)
    buildType(Subpr1_B11111)
    buildType(mygradle2)
})

object Subpr1_B11111 : BuildType({
    name = "b11"
...
object mygradle2 : BuildType({
    name = "gradle"

    vcs {
        root(Subpr1_HttpsGithubComChubatovaTigerChubatovaGradleTestsBackup)
    }
...
object Subpr1_HttpsGithubComChubatovaTigerChubatovaGradleTestsBackup : GitVcsRoot({
